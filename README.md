...
Los tests se ejecutan en modo watch por defecto. Presiona `Ctrl+C` para detener.
...
- **Servicios**: ProductsService, CartService
- **Componentes**: ProductCardComponent
...
- [ ] Filtros avanzados (rango de precios, ratings)
- [ ] Exportar/importar productos (CSV, JSON)
